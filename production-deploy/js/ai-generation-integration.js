...
class AIGenerationIntegration {
    ...
    async initializeAPIKey() {
        ...
        this.claudeAPIKey = process.env.CLAUDE_API_KEY || localStorage.getItem('claude_api_key');
        
        if (!this.claudeAPIKey) {
            console.warn('Claude API key not found. Please set CLAUDE_API_KEY environment variable or configure in settings.');
            return false;
        }
